...
<div style="display: flex; justify-content: space-between; width: 100%;">
  <img src="public/images/capture_2.png" alt="ToDo List App" style="width: 48%; border-radius: 10px; border: 2px solid #ccc;">
  <img src="public/images/capture_1.png" alt="ToDo List App" style="width: 48%; border-radius: 10px; border: 2px solid #ccc;">
</div>
